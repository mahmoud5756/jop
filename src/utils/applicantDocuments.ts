...
/** يربط تسمية المستند الناقص (زي ما بترجعها getMissingDocuments) بنوع
 * المستند المستخدم فعليًا وقت الرفع (document_type) — مستخدم في شاشة
 * "متابعة الفرع" عشان مدير الفرع يرفع المستند الناقص مباشرة. */
export const MISSING_LABEL_TO_DOCUMENT_TYPE: Record<string, string> = {
  [FRONT_LABEL]: 'صورة بطاقة الرقم القومي - الوجه',
  [BACK_LABEL]: 'صورة بطاقة الرقم القومي - الظهر',
  [HEALTH_LABEL]: 'شهادة صحية',
};
